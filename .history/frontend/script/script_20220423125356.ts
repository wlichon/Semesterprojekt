                    ...
                    success: function (response) {
                        ...
                        $.each(response, (i,val) =>{
                            ...
                            $("#appointments").append(
                                ...
                                "<input class= 'form-check-input' type ='test' name = 'ichtestenur' </input>" +
                                "<div class='col-md'><input class='form-check-input' type='checkbox' name ='checkboxnumber" + checkBoxId + "'value=''></div></div></div>" +
                                "</form>"
                            )
                            checkBoxId++;
