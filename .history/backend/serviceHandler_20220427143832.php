...
if (isset($_GET["param1"])) {
    ...
    $logic->insertIntoDB($function, $date, $meetingID, $title, $votingExpirationDate, $begin, $end, $terminoption1begin, $terminoption1end, $terminoption2begin, $param9, $param10, $param11, $param12);
}
