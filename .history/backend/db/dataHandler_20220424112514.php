...
class DataHandler
{
    ...
    {
        $demodata = [
            new Appointment("21-03-2022", "Meeting", "20-03-2022 12:00:00", "12:00", "13:00", [1, 2]),  // AppointmentKonstruktor: new Appointment ($date,$title,$votingExpirationDate,$begin,$end,$optionIDs) 
